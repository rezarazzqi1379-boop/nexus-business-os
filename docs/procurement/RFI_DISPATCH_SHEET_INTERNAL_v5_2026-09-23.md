...
**Removed by owner decision, 2026-09-23 (red flags, see `SUPPLIER_VERIFICATION_AND_SHORTLIST_2026-09-23.md`):** Wuxi Yushun (isunsteel), Shanghai Prime Metallurgy, Shanghai Fortune Electric / China Electric (Shanghai). They must not be re-added without a clean registry check. Their names stay on the Gate A grep list.
