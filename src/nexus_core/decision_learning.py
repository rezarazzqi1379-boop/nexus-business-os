...
def validate_decision_chain(
    ...
    This deliberately avoids uncalibrated numeric confidence scores. A future
    calibration layer may add probabilities only after enough predictions and
    outcomes exist to measure calibration quality.
    """
