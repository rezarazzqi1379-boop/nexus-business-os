...
Feed trace/evaluation failures, Outcome Ledger misses, CI regressions, and research-quality defects into `FailureObservation`; run candidate changes in isolated evaluation; record results; surface only promotable candidates to the approval layer.
